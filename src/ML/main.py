...
#Inicializando o interpretador tflite
interpreter = tflite.Interpreter(model_content=tflite_model)
interpreter.allocate_tensors()

# Obtendo detalhes das entradas e saídas do modelo
...
if(cond == True):
     ...
     input_data = np.array([[temp, hum, pres, gas,lumin]], dtype=np.float32)
     ...
     print("Previsão de chuva: ", output_data)
